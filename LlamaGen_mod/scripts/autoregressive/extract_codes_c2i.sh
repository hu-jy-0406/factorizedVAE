...
--master_port=12335 \
autoregressive/train/extract_latents_c2i.py \
--vq-ckpt /home/renderex/causal_groups/jinyuan.hu/ckpts/lamma_gen/vq_vae/vq_ds16_c2i.pt \
--data-path /home/renderex/causal_groups/jinyuan.hu/CIFAR10/train/ \
--code-path /home/renderex/causal_groups/jinyuan.hu/CIFAR10-latent/fvae/train/ \
--dataset cifar10 \
--dataset-type train \
--image-size 256 \
--modeltype fvae
